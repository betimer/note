...
3. server: get new client connect, try to communicate with it (server does not know the relation ship between this new request and previous failed one, server treated as 2 seperate clients)
...
6. client: get respose from server, and get the new socketioId.
